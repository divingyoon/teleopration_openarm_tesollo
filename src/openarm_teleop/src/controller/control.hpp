...
public:
    ...
    void SetEnableGripperReflectedEffort(bool enable);
    void SetBilateralGravityScale(double scale);
    void SetBilateralGravityScaleVector(const std::vector<double> &scale_vec);
    void SetBilateralGravityBiasVector(const std::vector<double> &bias_vec);
...
private:
    bool enable_gripper_reflected_effort_ = false;
    double bilateral_gravity_scale_ = 1.0;
    std::vector<double> bilateral_gravity_scale_vec_;
    std::vector<double> bilateral_gravity_bias_vec_;
};
